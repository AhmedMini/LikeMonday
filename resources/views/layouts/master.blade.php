    ...
    <nav class="side-navbar">
      <div class="side-navbar-wrapper">
        ...
        <div class="sidenav-header d-flex align-items-center justify-content-center">
          <!-- User Info-->
          <div class="sidenav-header-inner text-center"><img src="{{URL::to('assets/img/Ahmed.jpeg')}}" alt="person" class="img-fluid rounded-circle" data-toggle="modal" data-target="#profile">
            <h2 class="h5"> Ahmed Raven</h2>
            <span>Web Developer</span>
          </div>
          <!-- Small Brand information, appears on minimized sidebar-->
          <div class="sidenav-header-logo"><a href="assets/index.html" class="brand-small text-center"> <strong>S</strong><strong class="text-primary">S</strong></a></div>
        </div>
    ...
    <div class="page">
      ...
      <footer class="main-footer">
        <div class="container-fluid">
          <div class="row">
            <div class="col-sm-6">
              <p>Ahmed Othman Web Devoloper &copy; 2020</p>
            </div>
            <div class="col-sm-6 text-right">
              <p>Design by Ahmed<a href="#" class="external"></a></p>
            </div>
          </div>
        </div>
      </footer>
                    ...
                    <div class="modal-body">
                        <div class="modal-body">
                            <div class="form-group col">
                                <div class="sidenav-header-inner"><img src="{{URL::to('assets/img/Ahmed.jpeg')}}" alt="profile" class="img-fluid rounded-circle" width="10%"></div>
                                <br>
                                <div class="row">
